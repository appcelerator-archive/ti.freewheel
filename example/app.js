...
var field = Ti.UI.createTextField({ height: 44, top: 10, left: 10, right: 10, backgroundColor: '#fff', clearButtonMode: Ti.UI.INPUT_BUTTONMODE_ONFOCUS, keyboardType: Titanium.UI.KEYBOARD_NUMBER_PAD, borderStyle: Titanium.UI.INPUT_BORDERSTYLE_ROUNDED, value: Ti.App.Properties.getString('SavedVideoID', '') });
...
submit.addEventListener('click', function () {
    ...
    field.blur();
    Ti.App.Properties.setString('SavedVideoID', field.value);
});
